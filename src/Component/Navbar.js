...
<div id="navbar">
                <nav id="nav" >
                    ...
                    <div id="searchBlock">
                        ...
                        <div id="cartImage">
                         <form className='d-flex' role='search'>
                        {!localStorage.getItem("manager")&&!localStorage.getItem("employee")&&<img onClick={loginClick} id="logo" src="/images/cart2.png" alt="log" srcSet="" />}
                            {localStorage.getItem("employee")&&<img onClick={logClick} id="logo" src="/images/cart2.png" alt="sig" srcSet="" />}
                            {localStorage.getItem("manager")&&<img onClick={logClick} id="logo" src="/images/cart2.png" alt="sig" srcSet="" />}
                            </form>
                        </div>
